...
namespace eastl
{
	...
	/// EASTL_UNORDERED_SET_DEFAULT_NAME
	///
	/// Defines a default container name in the absence of a user-provided name.
	///
	#ifndef EASTL_UNORDERED_SET_DEFAULT_NAME
		#define EASTL_UNORDERED_SET_DEFAULT_NAME EASTL_DEFAULT_NAME_PREFIX " unordered_set" // Unless the user overrides something, this is "EASTL unordered_set".
	#endif


	/// EASTL_UNORDERED_MULTISET_DEFAULT_NAME
	///
	/// Defines a default container name in the absence of a user-provided name.
	///
	#ifndef EASTL_UNORDERED_MULTISET_DEFAULT_NAME
		#define EASTL_UNORDERED_MULTISET_DEFAULT_NAME EASTL_DEFAULT_NAME_PREFIX " unordered_multiset" // Unless the user overrides something, this is "EASTL unordered_multiset".
	#endif


	/// EASTL_UNORDERED_SET_DEFAULT_ALLOCATOR
	///
	#ifndef EASTL_UNORDERED_SET_DEFAULT_ALLOCATOR
		#define EASTL_UNORDERED_SET_DEFAULT_ALLOCATOR allocator_type(EASTL_UNORDERED_SET_DEFAULT_NAME)
	#endif

	/// EASTL_UNORDERED_MULTISET_DEFAULT_ALLOCATOR
	///
	#ifndef EASTL_UNORDERED_MULTISET_DEFAULT_ALLOCATOR
		#define EASTL_UNORDERED_MULTISET_DEFAULT_ALLOCATOR allocator_type(EASTL_UNORDERED_MULTISET_DEFAULT_NAME)
	#endif
	...
	/// unordered_set
	///
	/// Implements a unordered_set, which is a hashed unique-item container.
	...
	public:
		...
		/// Default constructor.
		/// 
		explicit unordered_set(const allocator_type& allocator = EASTL_UNORDERED_SET_DEFAULT_ALLOCATOR)
		...
		///
		explicit unordered_set(size_type nBucketCount, const Hash& hashFunction = Hash(), const Predicate& predicate = Predicate(), 
						  const allocator_type& allocator = EASTL_UNORDERED_SET_DEFAULT_ALLOCATOR)
		...
		unordered_set(const this_type& x)
		  : base_type(x)
		{
		}
			...
			unordered_set(this_type&& x)
			  : base_type(eastl::move(x))
			{
			}


			unordered_set(this_type&& x, const allocator_type& allocator)
		...
		/// Allows for initializing with brace values (e.g. unordered_set<int> hs = { 3, 4, 5, }; )
		///     
		...
		unordered_set(FowardIterator first, FowardIterator last, size_type nBucketCount = 0, const Hash& hashFunction = Hash(), 
				 const Predicate& predicate = Predicate(), const allocator_type& allocator = EASTL_UNORDERED_SET_DEFAULT_ALLOCATOR)
	...
	/// unordered_multiset
	///
	/// Implements a unordered_multiset, which is the same thing as a unordered_set 
	/// except that contained elements need not be unique. See the documentation 
	/// for unordered_set for details.
	///
	template <typename Value, typename Hash = eastl::hash<Value>, typename Predicate = eastl::equal_to<Value>, 
			  typename Allocator = EASTLAllocatorType, bool bCacheHashCode = false>
	...
	public:
		...
		typedef unordered_multiset<Value, Hash, Predicate, Allocator, bCacheHashCode>      this_type;
		typedef typename base_type::size_type                                         size_type;
		typedef typename base_type::value_type                                        value_type;
		typedef typename base_type::allocator_type                                    allocator_type;
		typedef typename base_type::node_type                                         node_type;
	...
	public:
		...
		/// Default constructor.
		/// 
		explicit unordered_multiset(const allocator_type& allocator = EASTL_UNORDERED_MULTISET_DEFAULT_ALLOCATOR)
			: base_type(0, Hash(), mod_range_hashing(), default_ranged_hash(), Predicate(), eastl::use_self<Value>(), allocator)
		{
			// Empty
		}
		...
		explicit unordered_multiset(size_type nBucketCount, const Hash& hashFunction = Hash(), 
							   const Predicate& predicate = Predicate(), const allocator_type& allocator = EASTL_UNORDERED_MULTISET_DEFAULT_ALLOCATOR)
			: base_type(nBucketCount, hashFunction, mod_range_hashing(), default_ranged_hash(), predicate, eastl::use_self<Value>(), allocator)
		{
			// Empty
		}
		...
		unordered_multiset(const this_type& x)
		  : base_type(x)
		{
		}
		...
		#if EASTL_MOVE_SEMANTICS_ENABLED
			unordered_multiset(this_type&& x)
			  : base_type(eastl::move(x))
			{
			}


			unordered_multiset(this_type&& x, const allocator_type& allocator)
			  : base_type(eastl::move(x), allocator)
			{
			}
		#endif
		...
		///
		/// initializer_list-based constructor. 
		/// Allows for initializing with brace values (e.g. unordered_set<int> hs = { 3, 3, 4, }; )
		///     
		...
		///
		template <typename FowardIterator>
		unordered_multiset(FowardIterator first, FowardIterator last, size_type nBucketCount = 0, const Hash& hashFunction = Hash(), 
					  const Predicate& predicate = Predicate(), const allocator_type& allocator = EASTL_UNORDERED_MULTISET_DEFAULT_ALLOCATOR)
			: base_type(first, last, nBucketCount, hashFunction, mod_range_hashing(), default_ranged_hash(), predicate, eastl::use_self<Value>(), allocator)
		{
			// Empty
	...
	inline bool operator==(const unordered_set<Value, Hash, Predicate, Allocator, bCacheHashCode>& a, 
						   const unordered_set<Value, Hash, Predicate, Allocator, bCacheHashCode>& b)
	{
		typedef typename unordered_set<Value, Hash, Predicate, Allocator, bCacheHashCode>::const_iterator const_iterator;
	...
	template <typename Value, typename Hash, typename Predicate, typename Allocator, bool bCacheHashCode>
	inline bool operator==(const unordered_multiset<Value, Hash, Predicate, Allocator, bCacheHashCode>& a, 
						   const unordered_multiset<Value, Hash, Predicate, Allocator, bCacheHashCode>& b)
	{
		typedef typename unordered_multiset<Value, Hash, Predicate, Allocator, bCacheHashCode>::const_iterator const_iterator;
