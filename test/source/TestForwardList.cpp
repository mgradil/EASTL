...
int TestForwardList()
{
	EASTLTest_Printf("TestForwardList\n");
	...
	// forward_list(const allocator_type& allocator);
	{ 
		MallocAllocator::reset_all();

		VERIFY(MallocAllocator::mAllocCountAll == 0);
		forward_list<int, MallocAllocator> list;
		list.resize(100, 42);
		VERIFY(MallocAllocator::mAllocCountAll == 100);
	}

	// explicit forward_list(size_type n, const allocator_type& allocator = EASTL_forward_list_DEFAULT_ALLOCATOR);
	{
	...
	// forward_list(size_type n, const value_type& value, const allocator_type& allocator = EASTL_forward_list_DEFAULT_ALLOCATOR);
	{
		forward_list<int> list(32, 42);
		VERIFY(list.size() == 32);
		VERIFY(list.front() == 42);
		VERIFY(!list.empty());
	}

	// forward_list(const this_type& x);
	{
	...
	// forward_list(std::initializer_list<value_type> ilist, const allocator_type& allocator = EASTL_forward_list_DEFAULT_ALLOCATOR);
	{
	...
	// forward_list(this_type&& x);
	{
	#if EASTL_MOVE_SEMANTICS_ENABLED
		forward_list<int> list1; 
		list1.resize(100,42);

		forward_list<int> list2(eastl::move(list1));
	...
	// forward_list(this_type&& x, const allocator_type& allocator);
	{ } 
	...
	// forward_list(InputIterator first, InputIterator last); 
	{
		...
		forward_list<int> list2(list1.begin(), list1.end());
		VERIFY(!list2.empty());
		VERIFY(list1 == list2);
	}
	...
	// const_reference front() const;
	{
		...
		const forward_list<int> clist1(list1); 
	...
	{
    #if !defined(EA_COMPILER_NO_INITIALIZER_LISTS)
		forward_list<int> list1 = {0,1,2,3,4};
		forward_list<int> list2 = {9,8,7,6,5};
		list1.insert_after(list1.begin(), list2.begin(), list2.end());
		VERIFY(list1 == forward_list<int>({0,9,8,7,6,5,1,2,3,4}));
	#endif
	}
	...
	{
    #if !defined(EA_COMPILER_NO_INITIALIZER_LISTS)
		forward_list<int> list1 = {0,1,2,3,4,5,6,7};

		auto p = list1.begin();
		p++; p++; p++;

		list1.erase(p);
		VERIFY(list1 == forward_list<int>({0,1,2,4,5,6,7}));

		list1.erase(list1.begin(), list1.end());
		VERIFY(list1 == forward_list<int>({}));
		VERIFY(list1.size() == 0);
		VERIFY(list1.empty());
	#endif
	}
	...
	// iterator erase_after(const_iterator before_first, const_iterator last);
	{
		...
		list1.erase_after(p);
		VERIFY(list1 == forward_list<int>({0,2,3,4,5,6,7}));
		VERIFY(list1.validate());

		list1.erase_after(p);
		VERIFY(list1 == forward_list<int>({0,3,4,5,6,7}));
		VERIFY(list1.validate());

		list1.erase_after(p);
		VERIFY(list1 == forward_list<int>({0,4,5,6,7}));
		VERIFY(list1.validate());

		list1.erase_after(p, list1.end());
		VERIFY(list1 == forward_list<int>({0}));
		VERIFY(list1.validate());
	#endif
	}
    ...
    #if !defined(EA_COMPILER_NO_INITIALIZER_LISTS)
		forward_list<int> list1 = {0,1,2,3,4};
		forward_list<int> list2 = {0,1,3,4};
    ...
    #if !defined(EA_COMPILER_NO_INITIALIZER_LISTS)
		forward_list<int> list1 = {0,1,2,3,4};
		forward_list<int> list2 = {4,3,2,1,0};
		VERIFY(list1 != list2);
	...
	{
    #if !defined(EA_COMPILER_NO_INITIALIZER_LISTS)
		forward_list<int> valid = {0,1,2,3,4,5,6,7};	
		{
			forward_list<int> list1 = {0,1,2,3};
			forward_list<int> list2 = {4,5,6,7};
		...
		}
		{
			...
			VERIFY(list1 == forward_list<int>({4,0,1,2,3}));
			VERIFY(list2 == forward_list<int>({5,6,7}));

			list1.splice(list1.begin(), list2, list2.begin());
			VERIFY(list1 == forward_list<int>({5,4,0,1,2,3}));
			VERIFY(list2 == forward_list<int>({6,7}));

			list1.splice(list1.begin(), list2, list2.begin());
			VERIFY(list1 == forward_list<int>({6,5,4,0,1,2,3}));
			VERIFY(list2 == forward_list<int>({7}));

			list1.splice(list1.begin(), list2, list2.begin());
			VERIFY(list1 == forward_list<int>({7,6,5,4,0,1,2,3}));
			VERIFY(list2 == forward_list<int>({}));
	...
	// void splice(const_iterator position, this_type&& x, const_iterator first, const_iterator last);
	{
	#if EASTL_MOVE_SEMANTICS_ENABLED && !defined(EA_COMPILER_NO_INITIALIZER_LISTS)
		{
			...
			VERIFY(list1 == forward_list<int>({4,5,6,7,0,1,2,3}));
		}
		{
			forward_list<int> list1 = {0,1,2,3};
			forward_list<int> list2 = {4,5,6,7};	
		...
		}
		{
			...
			VERIFY(list1 == forward_list<int>({4,5,0,1,2,3}));
		}
	#endif
	}
	...
	// void splice_after(const_iterator position, this_type& x, const_iterator first, const_iterator last);
	{
		...
		VERIFY(list1 == forward_list<int>({0,4,5,6,7,1,2,3}));
		VERIFY(list1.validate());
		VERIFY(list2.validate());
	#endif
	}
	...
	// void splice_after(const_iterator position, this_type&& x, const_iterator first, const_iterator last);
	{
		...
		}
		{
			...
			VERIFY(list1 == forward_list<int>({0,5,6,7,1,2,3}));
		}
		{
			forward_list<int> list1 = {0,1,2,3};
			forward_list<int> list2 = {4,5,6,7};	
			...
			VERIFY(list1 == forward_list<int>({0,5,6,1,2,3}));
		}
	#endif
	}
	...
	{
    #if !defined(EA_COMPILER_NO_INITIALIZER_LISTS)
		forward_list<int> list1 = {0, 1, 2, 2, 2, 3, 4, 5, 6, 7, 8, 9, 9, 8, 7, 6, 5, 4, 3, 2, 2, 2, 1, 0};
